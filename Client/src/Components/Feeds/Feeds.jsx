...
const Feeds = () => {
  ...
  useEffect(() => {
    ...
    if (!isNaN(postIndex-1)) {
      setTimeout(() => {
        if (BlogCards[postIndex-1]) {
          setPost(BlogCards[postIndex-1]);
        } else {
          setPost(null);
        }
        setLoading(false);
    ...
    <div className="nature-blog-post">
        ...
        <div className="hero-content-wrapper">
          ...
          >
            ...
            <div className="hero-meta">
              <span>By { 'Harish Reddy Yarramada'}</span>
              <span>•</span>
        ...
        >
          ...
          >
            ...
            <div className="share-buttons">
              ...
              <a href={`https://pinterest.com/pin/create/button/?url=${window.location.href}&media=${post.image}&description=${post.title}`} 
                 target="_blank" 
                 rel="noopener noreferrer"
      ...
      <style jsx global>{`
        ...
        .hero-section {
          ...
          position: relative;
          display: flex;
          align-items: flex-end; /* Changed to flex-end to align content at bottom */
